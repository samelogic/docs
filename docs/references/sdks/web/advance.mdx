...
#### Use without the Samelogic platform
...
This will start the SDK without any communication to Samelogic APIs. It will load the steps from the url specified in the config. This allows
