...
The workflow contains 2 steps. A Microsurvey step that will complete the workflow if it is canceled or it will pass the collected data to a Wehook step. The webhook step will attempt to send this data to a url and will complete the workflow if the request failed or succeed.
